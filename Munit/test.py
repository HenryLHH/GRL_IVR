...
parser.add_argument('--config', type=str,default='configs/carroad2road_folder.yaml', help="net configuration")
parser.add_argument('--input', type=str, default='inputs/B_80.jpg',  help="input image path")
parser.add_argument('--output_folder', type=str, default='results', help="output image path")
parser.add_argument('--checkpoint', type=str, default='./outputs/carroad2road_folder/checkpoints/gen_00010000.pt', help="checkpoint of autoencoders")
parser.add_argument('--style', type=str, default='inputs/A_80.jpg', help="style image path")
